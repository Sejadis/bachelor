...
\newcommand{\JMUTitle}[9]{
  ...
  \begin{center}
   ...
   \large Fachbereich Informatik\\
    ...
    Bearbeitungszeit: 16.12.2021 - 10.02.2022 % Die Bearbeitungszeit der Seminar-/ Abschlussarbeit ist hier einzutragen.
...
\lstset{ 
  ...
  morekeywords={*,...,if,then,while,do},            % if you want to add more keywords to the set
...
\hyphenation{Open-MANIPULATOR-X}
