...
Um einen \ac{RPG} für temporales Planen zu erweitern, werden Aktionen in Startaktionen $A_\vdash$ und Endaktionen $A_\dashv$ aufgeteilt.
Der Index $t$ einer Schicht entspricht nun einer Zeitmarke.\\
