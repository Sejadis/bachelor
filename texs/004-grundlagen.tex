...
\end{itemize}
Ein Problem ist eine Beziehung zwischen einer Aktion $C$ und einem kausalen Zusammenhang  $A \xrightarrow{p} B$, bei der die Aktion $C$ einen Effekt $~p$ hat.
...
\begin{itemize}
    ...
    \item P ist der Plan um den Zustant zu erreichen
    \item C ist eine Liste aller zeitlichen Einschänkungen der Schritte in $P$
\end{itemize}
Um eine Aktion zum Plan hinzuzufügen müssen deren Start- und Endpunkte hinzugefügt werdern.
Dies muss nicht in aufeinander folgenden Schritten geschehen.
Wird eine Aktion hinugefügt werden $F$ und $V$ entsprechend der Effekte angepasst.
Die Vorraussetzung um eine Aktion hinzufügen zu können ist, dass Q keine Aktion enthält, zu der die Effekte der neuen Aktion einen Konflikt darstellen würden.\\
...
Es soll ein Kompromiss zwischen den Vorteil von Total- und Partial-Order Planung gefunden werden.
