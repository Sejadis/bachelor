...
% Text Node
        \draw (189,163) node [anchor=north west][inner sep=0.75pt]   [align=left] {at(Home)};
% Text Node
        \draw (329,161) node [anchor=north west][inner sep=0.75pt]   [align=left] {at(Shop)};
% Text Node
...
% Text Node
        \draw (450,163) node [anchor=north west][inner sep=0.75pt]   [align=left] {has(Money)};
% Text Node
        \draw (399,232) node [anchor=north west][inner sep=0.75pt]   [align=left] {buy(Product, Money)};
% Text Node
        \draw (119,302) node [anchor=north west][inner sep=0.75pt]   [align=left] {at(Home)};
% Text Node
        \draw (361,303) node [anchor=north west][inner sep=0.75pt]   [align=left] {at(Shop)};
% Text Node
        \draw (233,302) node [anchor=north west][inner sep=0.75pt]   [align=left] {has(Money)};
% Text Node
        \draw (447,303) node [anchor=north west][inner sep=0.75pt]   [align=left] {has(Product)};
% Text Node
...
% Text Node
        \draw (30,163.4) node [anchor=north west][inner sep=0.75pt]    {$F_{1}$};
% Text Node
        \draw (30,231.4) node [anchor=north west][inner sep=0.75pt]    {$A_{1}$};
% Text Node
        \draw (30,301.4) node [anchor=north west][inner sep=0.75pt]    {$F_{2}$};
% Connection
